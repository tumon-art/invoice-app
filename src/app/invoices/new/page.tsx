...
export default function Home() {
  ...
  return (
    <main className=" mt-10 flex flex-col 
      ...
      <div className=" flex justify-between ">
        <form action={addInvoice} className=" w-full md:w-3/5 flex flex-col gap-3">
